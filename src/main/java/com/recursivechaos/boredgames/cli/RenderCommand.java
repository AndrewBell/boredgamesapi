package com.recursivechaos.boredgames.cli;

import com.google.common.base.Optional;
import com.recursivechaos.boredgames.BoredGamesConfiguration;
...
public class RenderCommand extends ConfiguredCommand<BoredGamesConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<BoredGamesConfiguration> bootstrap,
                       Namespace namespace,
                       BoredGamesConfiguration configuration) throws Exception {
